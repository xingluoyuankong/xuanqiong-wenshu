...
import type { AgentRun, AgentRunCommandType, AgentRunStep, AgentStateProjection, AgentToolResult } from '@/api/agent'
  ...
  <section class="agent-run-inspector" data-testid="agent-run-inspector" aria-label="Agent运行检查器">
    <XqPanel title="当前运行">
      <dl class="run-summary">
        <dt>状态</dt><dd data-testid="agent-run-status">{{ runStatus(run?.status) }}</dd>
