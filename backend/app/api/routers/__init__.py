...
from . import admin, agent, auth, project_members, llm_config, novels, optimizer, updates, writer, analytics, analytics_enhanced, foreshadowing, projects, review, outline, style, knowledge_graph, patch_diff, token_budget, clue_tracker, writing_skills, research, task_runtime
...
# 新增：写作技能路由
api_router.include_router(writing_skills.router)
