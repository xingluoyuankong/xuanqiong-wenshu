...
_VISIBLE_EVENT_KEYS: dict[str, set[str]] = {
    ...
    "tool_call_completed": {"tool_name", "step", "result_keys", "phase", "action_id", "result_ref"},
    "tool_call_result": {"tool_name", "step", "result_keys", "phase", "action_id", "result_ref"},
    "tool_call_failed": {"tool_name", "step", "error_type", "phase", "action_id", "result_ref"},
    "tool_cancelled": {"tool_name", "step", "phase", "action_id", "result_ref"},
    "step_reused": {"tool_name", "step", "phase", "action_id", "result_ref"},
    ...
    "run_failed": {"error_type", "reason", "phase", "action_id", "result_ref", "response_provider_called", "response_provider_fallback_reason"},
    "run_completed": {"artifact_id", "version_id", "phase", "action_id", "result_ref", "provider_called", "response_provider_called", "response_provider_fallback_reason"},
    "public_work_summary": {
        ...
        *,
        ...
        for _attempt in range(5):
            ...
            data: dict[str, Any] = {
                ...
                **({"result_ref": str(result_ref).strip()[:160]} if result_ref and str(result_ref).strip() else {}),
