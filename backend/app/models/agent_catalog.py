...
class AgentCatalogRelease(Base):
    ...
    manifest_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
...
class AgentProviderRelease(Base):
    ...
    tools_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
    capability_tags_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
    dependencies_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
...
class AgentCapabilityDefinition(Base):
    ...
    input_schema_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
    output_schema_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
    ...
    context_bindings_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
    capability_tags_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
...
class AgentRunCapabilitySnapshot(Base):
    ...
    digest: Mapped[str] = mapped_column(String(64), nullable=False, index=True)
    request_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
    resolved_scope_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
    selected_capability_ids_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
    exclusions_json: Mapped[list[Any]] = mapped_column(JSON, nullable=False, default=list, server_default=text("('[]')"))
...
class AgentCapabilityExecution(Base):
    ...
    idempotency_key: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    input_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
    input_digest: Mapped[Optional[str]] = mapped_column(String(64), nullable=True, index=True)
    output_json: Mapped[dict[str, Any]] = mapped_column(JSON, nullable=False, default=dict, server_default=text("('{}')"))
